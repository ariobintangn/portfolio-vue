...
export default {
  data() {
    return {
      images: [
        { image: './src/assets/irwan-claudia2.png', name: 'Irwan Claudia' },
        { image: './src/assets/company-clone.png', name: 'Company Clone' },
        { image: './src/assets/met-digital.png', name: 'MET Digital' },
        { image: './src/assets/met-digital.png', name: 'MET Digital' },
        { image: './src/assets/met-digital.png', name: 'MET Digital' }
      ]
    }
