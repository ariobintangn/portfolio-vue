...
<template>
    <div class="flex justify-center items-center h-[350px]">
        <img src="../assets/profilePic.jpeg" alt="profile picture" class=" h-[240px] w-[240px] rounded-full">
    </div>
    <div class="flex flex-col justify-center h-[200px] px-[24px] text-center">
